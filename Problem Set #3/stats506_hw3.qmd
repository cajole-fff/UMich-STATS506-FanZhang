...
According to the test above, we have a p-value of $0.006859187 < 0.05$, which means the apartment numbers appear to follow Benford's law. I think the apartment numbers would also pass as real data. 
...
This time we get a p-value $0.01689982 < 0.05$, which means the last digit of the street number also follows Benford's law.