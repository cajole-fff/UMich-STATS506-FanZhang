...
According to the simulation above, the winning amount roughly follows a normal distribution with non-zero mean, and the average winning amount is 49.9001, which is much greater than 0. Therefore, this is not a fair game.  -->
...
# plot(interaction.plot(x.factor = cars$torque, trace.factor = cars$horsepower, response = cars$highway_mpg, fun = mean, type = 'b', legend = TRUE)
```